...
export const UserProvider = ({ children }) => 
{
    ...
    const checkUserArtName = async (jwt_data, artName, address) => {
        ...
        try {
            ...
            const response = await axios.get(`${process.env.REACT_APP_API_ADDRESS}/user/check-artname/`, {
    ...
    const saveUserData = async (jwt_data, address, formData) => {
        ...
        try {
            const url = `${providerAddress}/user/details/${address}/`;
            const headers = {
    ...
    const authenticateUserRequest =  async (params) => {
        ...
        const url = `${providerAddress}/authenticate-user/`;
