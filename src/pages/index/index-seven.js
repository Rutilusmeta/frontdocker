    ...
    return (
        <>
            ...
            <section className="relative md:pb-24 pb-16 -mt-16">
                ...
                <Feature />
                <CollectionTwo title="Top Collection" description="We are a martketplace focussed on the Queer community. We shine the spotlight on Queer creators in a safe space."/>
                <AuctionsTwo title="Live Auctions" description="We are a martketplace focussed on the Queer community. We shine the spotlight on Queer creators in a safe space."/>

                <CreatorTwo title="Live Auctions" description="We are a martketplace focussed on the Queer community. We shine the spotlight on Queer creators in a safe space." />
            </section>
            <Footer />
            <Switcher />
        </>
